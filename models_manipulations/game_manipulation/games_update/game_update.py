            ...
            with get_session() as session:
                if last_game_in_api["numero"] - object_last_game_in_base.number == 1:
                    ...
                    game_temp = Game(
                        ...
                        fibonaccis=int(
                            GameCalcData.cont_fibonaccis(last_game_in_api["listaDezenas"])
                        ),
                        sum_fibonaccis=int(
                            GameCalcData.sum_fibonaccis(last_game_in_api["listaDezenas"])
                        ),
                        sum_general=int(
                    ...
                    for i in range(
                        object_last_game_in_base.number + 1, last_game_in_api["numero"] + 1
                    ):
                        ...
                        game_temp = Game(
                            ...
                            repeated_previous_game=int(
                                GameCalcData.count_repeated_previous_game(
                                    last_game_in_api["listaDezenas"], previous_game_balls
                                )
                            ),
                            pairs_repeated_previous_game=int(
                                GameCalcData.count_pairs_repeated_previous_game(
